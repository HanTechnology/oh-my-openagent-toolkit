...
| Service vernacular | `service-vernacular` is a supplementary language companion for repo-backed wording, public-copy boundaries, homepage/service prose, locale-native review, transcreation decisions, Korean-native specialization, and rewrite evidence. It is not a primary route and not a support claim. | `.opencode/skills/service-vernacular/SKILL.md`, `.opencode/skills/service-vernacular/reference/` |
...
For product-facing language across UI, docs, CLI, notifications, backend/API errors, admin/operator surfaces, onboarding, support, release notes, homepage/service prose, or public-copy boundaries, use `service-vernacular` as a supplementary language companion for evidence-backed wording, locale-native review, transcreation decisions, and Korean-native specialization. Keep implementation ownership with the primary route.
